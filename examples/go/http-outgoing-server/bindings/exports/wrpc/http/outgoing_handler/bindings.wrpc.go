...
import (
	...
	errors "errors"
	fmt "fmt"
	wasi__clocks__monotonic_clock "github.com/wrpc/wit-bindgen-wrpc/examples/go/http-outgoing-server/bindings/wasi/clocks/monotonic_clock"
	wasi__http__types "github.com/wrpc/wit-bindgen-wrpc/examples/go/http-outgoing-server/bindings/wasi/http/types"
	wrpc__http__types "github.com/wrpc/wit-bindgen-wrpc/examples/go/http-outgoing-server/bindings/wrpc/http/types"
