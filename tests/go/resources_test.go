//go:generate $WIT_BINDGEN_WRPC go --world resources-client --out-dir bindings/resources_client --package github.com/wrpc/wit-bindgen-wrpc/tests/go/bindings/resources_client ../wit
...
import (
	...
	"github.com/wrpc/wit-bindgen-wrpc/tests/go/bindings/resources_client/strange"
	"github.com/wrpc/wit-bindgen-wrpc/tests/go/bindings/resources_client/wrpc_test/integration/resources"
	"github.com/wrpc/wit-bindgen-wrpc/tests/go/bindings/resources_server"
	"github.com/wrpc/wit-bindgen-wrpc/tests/go/internal"
)
